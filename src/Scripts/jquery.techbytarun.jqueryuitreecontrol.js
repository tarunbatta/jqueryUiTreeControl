...
(function ($) {
  ...
  $.fn.btechcotree = function (options) {
    ...
    function GetNodeObjectFromXml(xmlnode) {
      ...
      result = {
        ...
        buttoncheck:
          $(xmlnode).attr('buttoncheck') == null
            ? false
            : $(xmlnode).attr('buttoncheck'),
        buttonadd:
          $(xmlnode).attr('buttonadd') == null
            ? false
            : $(xmlnode).attr('buttonadd'),
        buttonremove:
          $(xmlnode).attr('buttonremove') == null
            ? false
            : $(xmlnode).attr('buttonremove'),
        isdisabled:
          $(xmlnode).attr('isdisabled') == null
            ? false
            : $(xmlnode).attr('isdisabled'),
        ischecked:
          $(xmlnode).attr('ischecked') == null
            ? false
            : $(xmlnode).attr('ischecked'),
    ...
    function CreateNode(node) {
      ...
      if (
        node.buttoncheck ||
        (node.buttoncheck == null && $settings.show_button_check)
      ) {
        displaytree +=
          "<input type='checkbox' style='position:absolute; margin-top:1px;margin-left:" +
          item_margin +
          "px;'";
        if (node.isdisabled) {
      ...
      if (
        node.buttonadd ||
        (node.buttonadd == null && $settings.show_button_add)
      ) {
        displaytree +=
          "<span class='ui-icon " +
          $settings.class_node_add +
          "' data-action='add' style='position:absolute; margin-top:1px;margin-left:" +
          item_margin +
          "px;'></span>";
        item_margin += 20;
      }
      ...
      if (
        node.buttonremove ||
        (node.buttonremove == null && $settings.show_button_remove)
      ) {
        displaytree +=
          "<span class='ui-icon " +
          $settings.class_node_remove +
          "' data-action='remove' style='position:absolute; margin-top:1px;margin-left:" +
          item_margin +
          "px;'></span>";
        item_margin += 20;
      }
      ...
      if (node.href) {
        displaytree +=
          "<a href='" + node.href + "' target='" + node.target + "'>";
      }
      displaytree +=
        "<span style='margin-left:" + item_margin + "px;' data-action='text'";
    ...
    $("li div span[data-action='text']").bind('click', function (e) {
      $settings.onselectednode(
        $(this).parent('div').parent('li').attr('nodeid'),
    ...
    function HighlightNode(selectednode, flag) {
      $(
        '#' + $settings.containerid + " ul li div span[data-action='text']"
      ).removeClass($settings.class_node_highlight);
      ...
      if (flag) {
        $(selectednode)
          ...
          .addClass($settings.class_node_highlight);
      }
    }
    ...
    function StandardizeCheckSelection() {
      ...
      $('#' + $settings.containerid + ' ul li div')
        .find("input[type='checkbox']")
        .each(function () {
          if (
            $(this).is(':checked') &&
            ...
            $(this)
              ...
              .each(function () {
                if (
                  ...
                  $(this).find("input[type='checkbox']").attr('data-ischecked')
                ) {
  ...
  $.fn.btechcotree.GetRootNodes = function () {
    return $(
      '#' + $settings.containerid + '> ul > li > div > span:nth-child(1)'
    );
  };
  ...
  $.fn.btechcotree.ExpandCollapseTree = function (selectednode, flag) {
    if (flag) {
      if (
        !$(selectednode).parent('div').parent('li').next('ul').is(':visible')
      ) {
