...
export declare enum TreeDataFormat {
    Linear = 1,
    Hierarchy = 2
}
...
export interface TreeSettings {
    ...
    onprocessingerror: (xhr: JQuery.jqXHR, ajaxOptions: string, thrownError: string) => void;
    ...
    onselectednode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onbeforeaddnode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onafteraddnode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onbeforeremovenode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onafterremovenode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onaddnode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onremovenode: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
    onnodecheckselected: (id: string | number, node: JQuery, sender: JQuery.Event) => void;
}
